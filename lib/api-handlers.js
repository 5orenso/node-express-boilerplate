...
function ApiHandlers(opt, mockServices) {
    this.opts = opt || {};
...
//     that does not exist.
ApiHandlers.prototype.getArticles = function getArticles(id, opt) {
    var metricsStart = metrics.start();
    //if (opt) {
    //    console.log(__filename, opt);
    //}
    if (id) {
        metrics.timing('node-express-boilerplate.api_handlers.getArticles', metricsStart);
        return {
            httpStatusCode: 200,
            data: {
                id: id,
...
ApiHandlers.prototype.getArticlesComments = function getArticlesComments(id, opt) {
    var metricsStart = metrics.start();

    //if (opt) {
    //    console.log(__filename, opt);
    //}
    metrics.timing('node-express-boilerplate.api_handlers.getArticlesComments', metricsStart);
    return {
        httpStatusCode: 200,
        data: {
            id: id,
...
ApiHandlers.prototype.postArticles = function postArticles(id, opt) {
    //if (opt) {
    //    console.log(__filename, opt);
    //}
    return {
...
ApiHandlers.prototype.postArticlesComments = function postArticlesComments(id, opt) {
    //if (opt) {
    //    console.log(__filename, opt);
    //}
    return {
...
ApiHandlers.prototype.patchArticles = function patchArticles(id, opt) {
    //if (opt) {
    //    console.log(__filename, opt);
    //}
    return {
