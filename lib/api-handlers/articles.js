...
ApiHandlers.prototype.getArticles = function getArticles(id, opt, config) {
    return new Promise((resolve, reject) => {
        ...
        if (id) {
            // queryString:
            // expand:
            //     GET /api/articles/1234?expand=comments,author
            //         Expand comments and authors into the JSON object you return.
            // fields:
            //     GET /api/articles/1234?fields=id,title,comments(title)
            //         Only return the fields specified
            // limit:
            //     GET /api/articles/1234?limit=10
            // offset:
            //     GET /api/articles/1234?limit=10&offset=2
            resolve({
                httpStatusCode: 200,
                data: {
                    id: id,
                    ...
                    links: {
                        ...
                        href: 'http://example.com/articles/' + opt.resourceId,
                        author: {
                            self: 'http://example.com/articles/' + id + '/links/author',
                            href: 'http://example.com/articles/' + id + '/links/author',
                            related: 'http://example.com/articles/' + id + '/author',
                            linkage: {type: 'people', id: 9}
                        },
                        comments: {
                            first: { href: 'http://example.com/articles/' + id + '/links/comments?limit=25&offset=0' },
                            next: { href: 'http://example.com/articles/' + id + '/links/comments?limit=25&offset=1' },
                            last: { href: 'http://example.com/articles/' + id + '/links/comments?limit=25&offset=x' },
                            href: 'http://example.com/articles/' + id + '/links/comments',
            ...
            resolve({
                httpStatusCode: 200,
                first: { href: 'http://example.com/articles/?limit=25&offset=0' },
                next: { href: 'http://example.com/articles/?limit=25&offset=1' },
                last: { href: 'http://example.com/articles/?limit=25&offset=x' },
                data: [{
                    id: 1234,
                    title: 'Hello world'
                }]
